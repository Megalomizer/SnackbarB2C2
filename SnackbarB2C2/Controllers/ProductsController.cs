...
namespace SnackbarB2C2.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(SystemDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Products != null ? 
                          ...
                          Problem("Entity set 'SystemDbContext.Products'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Discount,Stock,ImgPath,Description")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
